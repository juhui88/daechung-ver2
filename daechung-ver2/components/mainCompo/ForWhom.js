...
import hexagon from "../../public/home/forWhom/hexagon.png";
import tw from "tailwind-styled-components";

const ImgWrap = tw.div`
relative flex justify-center items-center group transition-all
`;

const Span = tw.span`
  hidden group-hover:block  absolute text-3xl font-bold text-white
`;
